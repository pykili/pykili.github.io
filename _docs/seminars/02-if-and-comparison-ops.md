...
Если у Вас 1-й вариант, программа должна проверять свойства (2) и (4), 2-й — (3) и (4), 3-й — (1) и (5), 4-й — (2) и (5), 5-й — (3) и (5), 6-й — (5) и (6), 7-й — (1) и (4). То есть если у Вас, например, 3-й вариант, то Ваша программа должна проверять, дают ли `a` и `b` в сумме число `c` и получится ли `c`, если `a` разделить на `b`, и сообщать об этом.
