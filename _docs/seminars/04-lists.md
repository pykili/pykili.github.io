...
Программа должна спрашивать ваше имя.
...
Заполнить матрицу нужно определенным образом в зависимости от варианта.
...
Следует расплющить матрицу в одну строку. Например, для варианта 2 будет что-то такое:
