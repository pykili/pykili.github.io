...
$$O_\mathrm{итог} = 0.35\, O_\mathrm{экзамен} + 0.35\, O_\mathrm{контрольные} + 0.3\, O_\mathrm{домашние}$$
...
$$O_\mathrm{накоп} = (0.35\, O_\mathrm{контрольные} + 0.3\, O_\mathrm{домашние}) / 0.65 + 0.1\, O_\mathrm{бонусные}$$
...
Обратите внимания, что все в формулах стоят не округлённые величины, три оценки (итоговая, экзамен, накопленная), полученные из формул, округляются только перед внесением в ведомость.
