...
Можно использовать частеречный таггер для английского (можно самому найти, а можно написать [Антону](http://vk.ru/vantral/), у него есть на примете). Можно искать какие-то конструкции/слова и провести своё копрусное мини-исследование.
